  ...
  const techItems: TechItem[] = [
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
          <path d="M14.25.18a3.75 3.75 0 0 0-2.3 3.6v1.95h-5A3.75 3.75 0 0 0 3.2 9.5v2.85h3V9.5a.75.75 0 0 1 .75-.75h7.35a3.75 3.75 0 0 0 3.75-3.75V1.28A3.75 3.75 0 0 0 14.25.18zm-2.1 1.7a1.05 1.05 0 1 1 0 2.1 1.05 1.05 0 0 1 0-2.1zM9.75 23.82a3.75 3.75 0 0 0 2.3-3.6v-1.95h5a3.75 3.75 0 0 0 3.75-3.75v-2.85h-3v2.85a.75.75 0 0 1-.75.75H9.7a3.75 3.75 0 0 0-3.75 3.75v3.75A3.75 3.75 0 0 0 9.75 23.82zm2.1-1.7a1.05 1.05 0 1 1 0-2.1 1.05 1.05 0 0 1 0 2.1z"/>
        </svg>
      )
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
          <path d="M11.965.03c-2.316.03-4.58.536-6.657 1.547l5.96 4.966V3.882c0-.528.43-.957.957-.957h.519c.528 0 .957.429.957.957v2.859l1.83 1.527V3.882c0-.528.43-.957.957-.957h.519c.527 0 .957.429.957.957v5.33l1.83 1.527V6.015c0-.528.43-.957.957-.957h.519c.527 0 .957.429.957.957v6.299l1.79 1.492c.626-2.585.617-5.375-.112-7.925C19.789 2.502 16.143.208 11.965.03zm-11.83 7.848v6.096c0 .528.43.957.957.957h.519c.527 0 .957-.429.957-.957v-4.498l1.83 1.526V13.974c0 .528.43.957.957.957h.519c.527 0 .957-.429.957-.957V12.56l1.83 1.527v-.002l1.83 1.528V11.13c0-.528.43-.957.957-.957h.519c.528 0 .957.429.957.957v5.428l1.83 1.527V12.128c0-.528.43-.957.957-.957h.519c.527 0 .957.429.957.957v6.046l1.83 1.527v-5.61c0-.528.43-.957.957-.957h.519c.527 0 .957.429.957.957v6.626c1.233-1.636 2.05-3.526 2.388-5.545l-13.882-11.58L.135 7.878zm11.83 16.092c2.316-.03 4.58-.536 6.657-1.547L12 17.514v2.661c0 .528-.43.957-.957.957h-.519c-.528 0-.957-.429-.957-.957V17.316l-1.83-1.527v4.385c0 .528-.43.957-.957.957h-.519c-.527 0-.957-.429-.957-.957v-5.912l-1.83-1.527v3.297c0 .528-.43.957-.957.957h-.519c-.527 0-.957-.429-.957-.957v-4.811L.742 9.083c-.626 2.585-.617 5.375.112 7.925 1.433 3.38 5.079 5.674 9.257 5.852l1.854 1.11z"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="-11.5 -10.2 23 20.4" className="w-8 h-8 fill-none stroke-current" xmlns="http://www.w3.org/2000/svg" strokeWidth="1">
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
          <path d="M11.97 0L2.73 3.36v8.28c0 4.14 2.82 8.01 6.51 9.42L12 24l2.76-2.94c3.69-1.41 6.51-5.28 6.51-9.42V3.36L11.97 0zm6.9 8.88l-3.21 3.21-1.3-1.3c-.39-.39-1.02-.39-1.41 0l-2.48 2.48-1.3-1.3c-.39-.39-1.02-.39-1.41 0L6.6 13.23c-.39.39-.39 1.02 0 1.41l2.48 2.48c.39.39 1.02.39 1.41 0l3.21-3.21 1.3 1.3c.39.39 1.02.39 1.41 0l2.48-2.48 1.3 1.3c.39.39 1.02.39 1.41 0l1.17-1.17c.39-.39.39-1.02 0-1.41L18.87 8.88zm-6.9-6.38L18.9 5.1 12 7.6 5.1 5.1 12 2.5z"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
          <path d="M12.2 16.3c-2 .5-4.2.8-6.1.8-3.3 0-5.8-1.5-5.8-4.5 0-3.3 3.1-4.8 7.3-4.8 1.4 0 2.9.2 4 .5v-.6c0-1.7-.8-2.7-3.1-2.7-1.6 0-3.4.5-4.8 1.2-.3.2-.7 0-.7-.4L2.6 4c-.1-.3.1-.6.4-.7C5 2.2 7.7 1.6 10.3 1.6c5.1 0 7.8 2.4 7.8 7.3V16c0 1.2.1 2.2.4 3 .1.2 0 .5-.2.6l-2.2 1.6c-.3.2-.6 0-.7-.3l-.4-1.2h-.1c-1 1.2-2.7 2-4.7 2-3.1 0-5.3-1.8-5.3-4.5 0-3 2.6-4.5 6.6-4.5.9 0 1.9.1 2.7.3v-1.7zm-2.7-2c-2.3 0-3.7.8-3.7 2.3 0 1.3 1 2 2.5 2 1.7 0 3.2-1 3.8-2.3v-2c-.8-.2-1.7-.3-2.6-.3zm12.3 5.3c-3.6 2.7-8.8 4.1-13.4 4.1-5.1 0-9.6-1.7-12.3-4.6-.2-.3-.1-.7.2-.8.8-.5 1.8-.9 2.5-.9.2 0 .4.1.5.3 2.1 2.2 5.5 3.4 9.1 3.4 4 0 8.4-1.2 11.6-3.4.3-.2.7-.1.9.2l.7.8c.2.3.2.7-.2.9z"/>
        </svg>
      )
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm3.8 11.2c0 1.2-1 2.2-2.2 2.2H9.8V8.6h3.8c1.2 0 2.2 1 2.2 2.2v2.4zm-4.4-3.4H10v1.2h1.4c.3 0 .6-.3.6-.6 0-.3-.3-.6-.6-.6zm0 2.4H10V14h1.4c.3 0 .6-.3.6-.6 0-.3-.3-.6-.6-.6z"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm3.8 14.5c0 .6-.5 1.1-1.1 1.1H9.3v-7.2h5.4c.6 0 1.1.5 1.1 1.1v5zm-4.4-3.5H10v1.2h1.4c.3 0 .6-.3.6-.6 0-.3-.3-.6-.6-.6zm0 2.4H10v1.2h1.4c.3 0 .6-.3.6-.6 0-.3-.3-.6-.6-.6z"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
          <path d="M19 4H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-9 12H7v-2h3v2zm0-4H7V9h3v2zm7 4h-5v-2h5v2zm0-4h-5V9h5v2z"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 2c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm1 10h-2V7h2v5zm0 4h-2v-2h2v2z"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
          <path d="M18.9 10.9L13.1 5.1c-.8-.8-2-.8-2.8 0L8.7 6.7l3.2 3.2c.8-.3 1.8-.1 2.4.6.6.6.8 1.6.5 2.4l3.2 3.2c.8-.3 1.8-.1 2.4.6.9.8.9 2.2 0 3-.8.9-2.2.9-3 0-.6-.6-.8-1.6-.5-2.4L13.7 13.7c-.3.3-.6.4-1 .4-.4 0-.8-.1-1-.4l-3-3-4.6 4.6c-.8.8-.8 2 0 2.8l10.2 10.2c.8.8 2 .8 2.8 0l10.2-10.2c.8-.8.8-2 0-2.8z"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-none stroke-current" xmlns="http://www.w3.org/2000/svg" strokeWidth="2">
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-none stroke-current" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.8">
          <circle cx="12" cy="5" r="2" className="fill-current"/>
          <circle cx="6" cy="13" r="2" className="fill-current"/>
          <circle cx="18" cy="13" r="2" className="fill-current"/>
          <circle cx="12" cy="19" r="2" className="fill-current"/>
          <line x1="12" y1="7" x2="6" y2="11"/>
          <line x1="12" y1="7" x2="18" y2="11"/>
          <line x1="6" y1="15" x2="12" y2="17"/>
          <line x1="18" y1="15" x2="12" y2="17"/>
        </svg>
      )
    }
  ];
