...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[calc(100vh-80px)] flex flex-col items-center justify-center pt-28 pb-16 px-6 overflow-hidden">
      ...
      {/* Main container */}
      <div className="w-full max-w-6xl mx-auto z-10 flex flex-col gap-16 md:gap-24">
        ...
        <motion.div
          ...
          className="w-full min-w-0 max-w-full relative px-2 sm:px-4"
        >
          <CodeSnippet />
